...
public class Communicator_Console implements SerialPortEventListener {
    ...
    public void connect() {
        ...
        try {
            ...
            logText = selectedPortIdentifier.getName()  + " is in use. (" + e.toString() + ")";
            System.out.println(logText);
        } catch (Exception e) {
            logText = "Failed to open " + selectedPortIdentifier.getName()  + "(" + e.toString() + ")";
            System.out.println(logText);
        }
    }
        ...
        if (evt.getEventType() == SerialPortEvent.DATA_AVAILABLE) {
            try {
                ...
                if(attRSSI){
                    ...
                    bufferTrame[b] = new TrameXBee((char)buffer1,(char)buffer2,(char)input.read(),(char)input.read(),(char)input.read());
                    //System.out.println(bufferTrame[b].toString());
                    b = (b+1)%10;
